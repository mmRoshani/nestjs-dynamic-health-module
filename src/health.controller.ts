...
export class HealthController {
  ...
  constructor(
    ...
    private readonly _mongo? //! @Inject(Health.SEQUELIZE) //! private readonly _sequelize?, //! @Inject(Health.TYPE_ORM) //! private readonly _typeOrm?
  ) {
    /**********************************
     *
     *     null("pingCheck")
    ...
    Object.keys(this).forEach((key) => {
      if (key.startsWith("_") && this[key] !== null) {
        ...
        switch (key) {
          ...
          //! case "_mikroOrm":
          //!   this.healthRay.push(() =>
          //!     this.mikroOrm.pingCheck(value.key, value.options)
          //!   );
          //!   break;
          case "_mongo":
            this.healthRay.push(() =>
          ...
          //! case "_sequelize":
          //!   this.healthRay.push(() =>
          //!     this.sequelize.pingCheck(value.key, value.options)
          //!   );
          //!   break;
          //! case "_typeOrm":
          //!   this.healthRay.push(() =>
          //!     this.typeOrm.pingCheck(value.key, value.options)
          //!   );
          //!   break;
